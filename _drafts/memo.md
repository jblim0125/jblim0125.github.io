...
- 기능 추가와 보완 방향으로 진행
- 신규 온톨로지 대상 데이터 적재
- 데이터 적재 후 신규 온톨로지 데이터를 활용한 수주 AI 기능 개발

- 수집 데이터를 자동으로 적재하는데 -> 파이프라인(룰 기반) 데이터 적재 수행
  - 수주 AI에서 데이터 문제를 자동으로 검출하고 대응하는 방안

## 고속 병렬 파일 처리 시스템

각 주제 별 과제들과의 연동되는 부분이 있으므로 년차별 아웃풋을 정리하고 공유한다.

- ai 반도체 기반 데이터센터 컴포저블 클러스터 인프라 구축 및 검증 과제와의 연계 
- 